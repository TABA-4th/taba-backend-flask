...
def db_save_survey():
    try:
        ...
        sql = "INSERT INTO member_survey (SURVEY_ID, MEMBER_ID, SURVEY_DATE, GENDER, OLD, USE_AGE_TERM, PERM_TERM, DYE_TERM, RECOMMEND_OR_NOT, REUSE_IMAGE) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
        values = (survey_id, Instance.member_id, Instance.db_time, dbSaveGender, dbSaveOld, Instance.member_use_age_term, Instance.member_perm_term, Instance.member_dye_term, Instance.member_recommend_or_not, Instance.member_reuse_image)
